...
namespace CodeBase.UI.Services.Factory
{
  public class UIFactory : IUIFactory
  {
    ...
    public void CreateShop()
    {
      ...
      window.Construct(_adsService,_progressService, _apiService, _assets);
    }
